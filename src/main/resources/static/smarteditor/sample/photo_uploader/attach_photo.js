    ...
    function html5Upload() {	
		...
		sUploadURL= '/smartEditor/multiImageUpload'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
			...
			sUrl  : '/smartEditor/singleImageUpload',	//샘플 URL입니다.
			sCallback :'/smarteditor/sample/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
